...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        property: "og:image",
        content: "https://chihiroanihr.github.io/resume/images/og.png",
      },
    ],
    ...
    [
      "meta",
      {
        ...
        content: "Rhina Kim's Resume - Creative Engineer (JA)",
      },
    ],
    [
      "meta",
      { property: "og:url	", content: "https://chihiroanihr.github.io/resume" },
    ],
  ],
  themeConfig: {
    nav: [{ text: "Home", link: "/" }],
